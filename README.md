...
You can do this with a PostBuildEvent in Visual Studio like this (Notice how it copies to `HotReloadMods` first, because if Resonite is open it can't overwrite the file in `rml_mods`:
